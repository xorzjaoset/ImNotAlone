   <div class="container">
            <div class="row clients-row">
                <div class="col-md-2 col-sm-4">
                    <a href="#"><img src="/ImNotAlone/resources/images/cl1.png" alt="" class="img-responsive"></a>
                </div>
                <div class="col-md-2 col-sm-4">
                    <a href="#"><img src="/ImNotAlone/resources/images/cl2.png" alt="" class="img-responsive"></a>
                </div>
                <div class="col-md-2 col-sm-4">
                    <a href="#"><img src="/ImNotAlone/resources/images/cl3.png" alt="" class="img-responsive"></a>
                </div>
                <div class="col-md-2 col-sm-4">
                    <a href="#"><img src="/ImNotAlone/resources/images/cl4.png" alt="" class="img-responsive"></a>
                </div>
                <div class="col-md-2 col-sm-4">
                    <a href="#"><img src="/ImNotAlone/resources/images/cl2.png" alt="" class="img-responsive"></a>
                </div>
                <div class="col-md-2 col-sm-4">
                    <a href="#"><img src="/ImNotAlone/resources/images/cl5.png" alt="" class="img-responsive"></a>
                </div>
            </div>
        </div>
        <div class="gray-bg pt80 pb40">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3 mb30">
                        <div class="card-overlay">
                            <img src="/ImNotAlone/resources/images/img1.jpg" class="img-responsive" alt="">
                    ...
                    <div class="col-sm-6 col-md-3 mb30">
                        <div class="card-overlay">
                            <img src="/ImNotAlone/resources/images/img2.jpg" class="img-responsive" alt="">
                            <div class="card-hover">
                                <div class="card-content">
                    ...
                    <div class="col-sm-6 col-md-3 mb30">
                        <div class="card-overlay">
                            <img src="/ImNotAlone/resources/images/img3.jpg" class="img-responsive" alt="">
                            <div class="card-hover">
                                <div class="card-content">
                    ...
                    <div class="col-sm-6 col-md-3 mb30">
                        <div class="card-overlay">
                            <img src="/ImNotAlone/resources/images/img4.jpg" class="img-responsive" alt="">
                            <div class="card-hover">
                                <div class="card-content">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3 mb30">
                        <div class="card-overlay">
                            <img src="/ImNotAlone/resources/images/img5.jpg" class="img-responsive" alt="">
                            <div class="card-hover">
                                <div class="card-content">
                    ...
                    <div class="col-sm-6 col-md-3 mb30">
                        <div class="card-overlay">
                            <img src="/ImNotAlone/resources/images/img6.jpg" class="img-responsive" alt="">
                            <div class="card-hover">
                                <div class="card-content">
                    ...
                    <div class="col-sm-6 col-md-3 mb30">
                        <div class="card-overlay">
                            <img src="/ImNotAlone/resources/images/img7.jpg" class="img-responsive" alt="">
                            <div class="card-hover">
                                <div class="card-content">
                    ...
                    <div class="col-sm-6 col-md-3 mb30">
                        <div class="card-overlay">
                            <img src="/ImNotAlone/resources/images/img8.jpg" class="img-responsive" alt="">
                            <div class="card-hover">
                                <div class="card-content">
                        ...
                        <div class="owl-carousel owl-theme testimonial-slider mb40">
                            <div class="item">
                                <div class="testimonial-card">
                                    ...
                                    <div class="testimonial-author clearfix">
                                        <img src="/ImNotAlone/resources/images/av1.jpg" alt="" class="img-responsive img-circle pull-left" width="90">
                            ...
                            <div class="item">
                                <div class="testimonial-card">
                                    ...
                                    <div class="testimonial-author clearfix">
                                        <img src="/ImNotAlone/resources/images/av2.jpg" alt="" class="img-responsive img-circle pull-left" width="90">
                                        <div class="author-meta">
                                            <h5 class="mb0">John Doe</h5>
                                            <em>Finder Customer</em>
                                            <ul class="list-inline mb0 rating-list">
                            ...
                            <div class="item">
                                <div class="testimonial-card">
                                    ...
                                    <div class="testimonial-author clearfix">
                                        <img src="/ImNotAlone/resources/images/av3.jpg" alt="" class="img-responsive img-circle pull-left" width="90">
                                        <div class="author-meta">
                                            <h5 class="mb0">John Doe</h5>
                                            <em>Finder Customer</em>
                                            <ul class="list-inline mb0 rating-list">
        ...
        <div class="dark-bg pt80 pb40 mb70 bg-parallax parallax-overlay" data-jarallax='{"speed": 0.2}' style='background-image: url(/ImNotAlone/resources/images/bg3.jpg)'>
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 text-center center-heading mb40">
        ...
        <div class="container mb40">
            ...
            <div class="row">
                <div class="col-sm-4 mb40">
                    <div class="post-card">
                        <a href="#"><img src="/ImNotAlone/resources/images/img2.jpg" alt="" class="img-responsive mb15"></a> 
                ...
                <div class="col-sm-4 mb40">
                    <div class="post-card">
                        <a href="#"><img src="/ImNotAlone/resources/images/img3.jpg" alt="" class="img-responsive mb15"></a> 
                        <div class="post-content">
                            <h4><a href="#">Standard post with image</a></h4>
                            <p>
                                It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout...
                ...
                <div class="col-sm-4 mb40">
                    <div class="post-card">
                        <a href="#"><img src="/ImNotAlone/resources/images/img4.jpg" alt="" class="img-responsive mb15"></a> 
                        <div class="post-content">
                            <h4><a href="#">Standard post with image</a></h4>
                            <p>
                                It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout...
